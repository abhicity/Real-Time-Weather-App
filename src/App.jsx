...
// } from './utils/Helper.jsx'; // Placeholder helper functions

const App = () => {
    const [weather, setWeather] = useState(null);
    const [city, setCity] = useState('');
    const [suggestion, setsSuggestion] = useState([]);
    const [unit, setUnit] = useState('C');
    const [error, setError] = useState('');
    const API_KEY = 'ed0fd963121fe37f49729616710e6d72';
    ...
    const fetchSuggestions = async (query) => {
        try {
            ...
            res.ok ? setsSuggestion(await res.json()) : setsSuggestion([]);
        } catch {
            setsSuggestion([]);
        }
    };
